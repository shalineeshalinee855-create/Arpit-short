...
TEMP_SECRETS_FILE = 'temp_secrets.json' # Auth fix के लिए अस्थायी फ़ाइल
...
# --- YouTube Auth Logic (RENDER Optimized - FINAL FIX) ---
...
def get_authenticated_service():
    ...
    if not credentials or not credentials.valid:
        if credentials and credentials.expired and credentials.refresh_token:
            ...
            # FIX: Temporarily create a secrets file for robust loading
            with open(TEMP_SECRETS_FILE, 'w') as f:
                f.write(secrets_data)
            
            # flow को अब अस्थायी फ़ाइल से लोड करें
            ...
            # run_local_server का उपयोग करें क्योंकि Render एक वेब सेवा है
...
async def worker_job(application: Application):
    ...
    while not stop_event.is_set():
        try:
            ...
            # FIX: Use asyncio.to_thread for blocking call
